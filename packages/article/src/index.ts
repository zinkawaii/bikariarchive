export { default as article } from "./collections/article.ts";
export { default as entry } from "./collections/entry.ts";
export { default as update } from "./collections/update.ts";
